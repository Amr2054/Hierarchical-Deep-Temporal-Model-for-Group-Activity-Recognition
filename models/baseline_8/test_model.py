...
from data import PlayerGroupActivityDataset_B8
...
if __name__ == "__main__":
    ...
    # Environment Setup
    env = setup_environment(baseline_name="baseline_8_test")
    config = load_config(args.config)
    set_seed(42)

    logger = setup_logger(env['run_dir'],mode="test")
    logger.info(" Starting Baseline 8 Test Evaluation Pipeline")
    ...
    test_set = PlayerGroupActivityDataset_B8(
