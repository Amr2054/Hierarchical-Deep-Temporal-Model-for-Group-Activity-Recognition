...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate Baseline 4 on the Test Set")
    ...
    # Environment Setup
    env = setup_environment(baseline_name="baseline_4_test")
    config = load_config(args.config)
    set_seed(42)

    logger = setup_logger(env['run_dir'])
    logger.info(" Starting Baseline 4 Test Evaluation Pipeline")
    ...
    test_set = SequenceActivityDataset(
        videos_path,
        annot_path,
